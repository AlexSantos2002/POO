...
public class Cliente {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Leitura dos pontos do segmento
            Ponto s1 = new Ponto(sc.nextInt(), sc.nextInt());
            Ponto s2 = new Ponto(sc.nextInt(), sc.nextInt());
            ...
            if (!p1.noPrimeiroQuadrante() || !p2.noPrimeiroQuadrante() || !p3.noPrimeiroQuadrante() || !p4.noPrimeiroQuadrante()) {
                ...
                Segmento segmento = new Segmento(s1, s2);
                System.out.println(retangulo.intersecaSegmento(segmento) ? "1" : "0");
            }
